...
public class DynamicAvroParser {
        ...
        Schema schemaAccount = new Schema.Parser().parse(new File("src/main/resources/avro/account.avsc"));

        // Path to the Avro file
        String pathAccount = "dynamic_accounts.avro";
    ...
    public static void writeGenericRecords(Schema schema, String path) throws IOException {
        ...
        account.put("bankIdentifier", "1234");
    ...
    public static void readSpecificRecords(Schema schema, String path) throws IOException {
        try {
            ...
            SpecificDatumReader<AccountCreated> datumReader = new SpecificDatumReader<>(AccountCreated.class);

            // Construct a DataFileReader instance to read the data
            try (DataFileReader<AccountCreated> dataFileReader = new DataFileReader<>(file, datumReader)) {
                AccountCreated account = null; // Reusable Account object
